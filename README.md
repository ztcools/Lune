...
>
> 🤖 **CI/CD automated testing & deployment (GitHub Actions: backend/agent/frontend tests + self-hosted runner builds & deploys) at [docs/CI-CD.md](docs/CI-CD.md)**
>
...
| `AGENT_MODEL` | Model name | ❌ (default claude-haiku-4-5-20251001, non-reasoning) |
